...
DataModelTree::LambdaPropertyListener<WeakReferenceable>::LambdaPropertyListener (WeakReferenceable& obj_,
                                                                                  DataModelTree::ListenerBase::Type type,
...
template <typename T>
void DataModelTree::addLambdaPropertyListenerT (T& obj,
                                                DataModelTree::ListenerBase::Type type,
                                                const Array<Identifier>& ids,
